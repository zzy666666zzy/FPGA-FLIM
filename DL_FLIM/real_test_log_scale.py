...
# sample_file='mixed_beads_LogScale.mat'
...
hist=DataSet.get('log_hist')  
hist_nor=DataSet.get('log_hist_nor')
...
plt.show()
#%%for beads
plt.imshow(tau_amp[1:251,5:256], cmap='nipy_spectral')#nipy_spectral, 
cb=plt.colorbar()
cb.ax.tick_params(labelsize=15)
plt.clim(0, 4)
plt.axis('off')
...
plt.axis('off')
plt.show()
savemat(r"./mat_result/YG_beads_AdderNet_LS.mat", {"YG_beads_AdderNet_LS":tau_inten[1:251,5:256]})
#%%
