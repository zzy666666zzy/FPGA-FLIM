...
class S_TauNet_AVE(Module):
    '''
    Model for calculating the fluorescence lifetimes
    '''
    def __init__(self):
        super(S_TauNet_AVE, self).__init__()
        self.PreRes1_conv = Conv_Add(1,5,1,13,5)
        self.PreRes1_bn = BatchNorm2d(5)
        
        self.PreRes2_conv = Conv_Add(5,10,1,9,3)
        self.PreRes2_bn = BatchNorm2d(10)
            
        self.R1 = ResBlock(10,10)
        
        self.O1_1_conv = Conv_Add(140,70,1,1,1)
        self.O1_1_bn = BatchNorm2d(70)
        self.O1_2_conv =  Conv_Add(70,30,1,1,1)
        self.O1_2_bn = BatchNorm2d(30)
        self.O1_3_conv = Conv_Add(30,1,1,1,1)
        self.O1_3_bn = BatchNorm2d(1)
        
        self.O2 = Sequential(Conv_Add(140,70,1,1,1),
                             BatchNorm2d(70),
                             ReLU(),
                             Conv_Add(70,30,1,1,1),
                             BatchNorm2d(30),
                             ReLU(),
                             Conv_Add(30,1,1,1,1),
                             BatchNorm2d(1),
